...
SOURCEFILES_QUOTED_IF_SPACED=Disp7SEG.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Disp7SEG.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Disp7SEG.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Disp7SEG.o

# Source Files
SOURCEFILES=Disp7SEG.s
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Disp7SEG.o: Disp7SEG.s  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Disp7SEG.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/Disp7SEG.o \
	Disp7SEG.s \
...
dist/${CND_CONF}/${IMAGE_TYPE}/Display.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o dist/${CND_CONF}/${IMAGE_TYPE}/Display.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
